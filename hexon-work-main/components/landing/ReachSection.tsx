    ...
    <div className="mt-24">
      <div className="w-[90vw] sm:w-3/4 mx-auto bg-gradient-to-br from-gray-50 via-white to-blue-50 rounded-2xl p-8 shadow-lg">
        <div className="text-center mb-12">
          <h2 className="mt-12 mb-6 italic text-3xl lg:text-4xl font-bold text-zinc-800 drop-shadow-md shadow-black">Zasięg Działania</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
            Realizuję projekty dla klientów w całej Polsce. Współpracuję zdalnie, zapewniając profesjonalną obsługę bez względu na lokalizację.
          </p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-sm text-gray-700">Zrealizowane projekty</span>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg">
            ...
            <p className="text-sm text-green-700">Wrocław, Poznań, Zielona Góra</p>
        ...
        <div className="mt-8 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white">
            <h3 className="text-xl font-bold mb-2">Gotowy na rozpoczęcie współpracy?</h3>
            <p className="mb-4 opacity-90">Niezależnie od tego, gdzie się znajdujesz - jestem gotowy pomóc w realizacji Twojego projektu</p>
            <button className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">Skontaktuj się ze mną</button>
          </div>
        </div>
      </div>
    </div>
